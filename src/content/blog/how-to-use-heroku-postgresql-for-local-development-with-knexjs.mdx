...
description: 'Connect once, deploy anywhere. A practical guide to seamless database workflows.'
publishedAt: 2019-12-01
coverImage: null
tags: ['postgres', 'heroku', 'knex', 'database']
---

Edit: This article is quite outdated. In 2025, Supabase and Neon are now the defacto free-tier database providers. Keeping this article here for posterity.
...
For Mac, I've found that [Postgres.app](https://Postgres.app) was the least hassle to get everything running.
